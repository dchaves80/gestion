...
namespace Christoc.Modules.ConfiguracionesDeCuenta.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.ConfiguracionesDeCuenta.Data.SqlDataprovider,ConfiguracionesDeCuenta";
