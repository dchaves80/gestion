...
namespace Christoc.Modules.Facturacion3
{
    ...
    /// 
    /// Because the control inherits from Facturacion3SettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : Facturacion3ModuleSettingsBase
    {
